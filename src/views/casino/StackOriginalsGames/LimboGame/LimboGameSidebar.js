...
function LimboGameSidebar() {
  ...
  //       setValues({
  //         ...values,
  //         autoBetCount: Math.max(remainingBets, 0).toString(), // Ensure value doesn't go below 0
  //       })
  //     );
  //   }
  ...
  // useEffect(() => {
  //   if (limboStatusData.autoBetRound && values.autoBetCount > 0) {
  //     const remainingBets =
  //       values.autoBetCount - limboStatusData.autoBetRound + 1;
  //     if (remainingBets >= 1) {
  //       dispatch(
  //         setValues({
  //           ...values,
  //           autoBetCount: remainingBets,
  //         })
  //       );
  //     }
  //   }
  ...
  useEffect(() => {
    // Update autoBetCount dynamically based on limboStatusData.autoBetRound
    if (limboStatusData?.autoBetRound && values.autoBetCount) {
      const remainingBets =
        parseInt(values.autoBetCount, 10) - limboStatusData.autoBetRound;
      dispatch(
