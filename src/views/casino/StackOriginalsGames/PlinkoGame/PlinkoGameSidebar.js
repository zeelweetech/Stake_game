...
function PlinkoGameSidebar() {
  ...
  return (
    <div>
      ...
      {responsiveMobile <= 768 ? (
            <div className={`ml-2 max-sm:mr-2 xl:w-80 lg:w-[16.8rem] flex flex-col p-3 bg-[#213743] ${isMdScreen ? "md:mx-40" : "md:mx-0"
            } `}>
            ...
            {isManual ? (
                ...
                <div className="flex border-2 rounded-md border-[#4d718768] bg-[#4d718768]">
                  <div className="relative flex">
                    ...
                    <input
                      ...
                      value={values?.betamount}
                      onChange={(e) => handleOnChange(e)}
                      className={`xl:w-48 lg:w-36  pr-1.5 pl-2 py-2 md:w-[16rem] sm:w-[10rem] w-64 rounded-s-md text-white bg-[#0f212e] ${completeBetStatus && "cursor-not-allowed"
                        }`}
                      disabled={completeBetStatus}
                    />
                  </div>
                  ...
                  <div className="flex border-2 rounded-md border-[#4d718768] bg-[#4d718768]">
                    <div className="relative flex">
                      ...
                      <input
                        ...
                        value={values?.betamount}
                        onChange={(e) => handleOnChange(e)}
                        className={`w-64 pr-1.5 pl-2 py-2.5 rounded-s-md text-white bg-[#0f212e] ${completeBetStatus && "cursor-not-allowed"
                          }`}
                        disabled={completeBetStatus}
                      />
                    </div>
              ...
              <div className="bg-[#0f212e] flex grow rounded-full p-[4px] flex-shrink-0">
                <div className="flex space-x-2">
                  <button
                    className={`py-2 xl:w-[8.7rem] lg:w-[7.1rem] md:w-[10.4rem] w-[11.4rem] max-[375px]:w-[9.8rem] max-[414px]:w-[11rem] max-[390px]:w-[10.3rem] max-[430px]:w-[11.6rem] max-[412px]:w-[11rem] max-[360px]:w-[9.4rem] max-[400px]:w-[10.65rem] rounded-full ${isManual ? "bg-[#4d718768]" : "hover:bg-[#4d718768]"
                      }`}
                    onClick={() => setIsManual(true)}
                  >
                    Manual
                  ...
                  <button
                    className={`py-2 xl:w-[8.8rem] lg:w-[7.2rem] md:w-[11.4rem] w-[11.4rem] max-[375px]:w-[9.9rem] max-[414px]:w-[11.1rem] max-[390px]:w-[10.3rem] max-[430px]:w-[11.6rem] max-[412px]:w-[11rem] max-[360px]:w-[9.4rem] max-[400px]:w-[10.65rem] rounded-full ${!isManual ? "bg-[#4d718768]" : "hover:bg-[#4d718768]"
                      }`}
                    onClick={() => setIsManual(false)}
                  >
                    Auto
