...
function DragonSidebar() {
  ...
  const handleOnAutoBet = () => {
    if (!localStorage.getItem("token")) {
      ...
      // DragonTowerSocket.emit("StartAutoBet", {
          ...
          {isManual ? (
            <div>
              ...
              <div>
                ...
                <div
                  className={`relative flex border-2 rounded ${showRandomField ? "" : "hover:border-[#557086]"
              ...
              <div>
                ...
                <RiMoneyRupeeCircleFill color="yellow" className="text-xl" />
                    ...
                    <input
                      ...
                      className={`xl:w-48 lg:w-36 md:w-72 pr-1.5 pl-2 py-2 w-64 rounded-l-md text-white border-2  hover:border-[#557086] border-[#2F4553] bg-[#0f212e] focus:outline-none ${showRandomField && "cursor-not-allowed opacity-80"
                        }`}
                      disabled={showRandomField}
                    />
                  </div>
                ...
                <div>
                  ...
                  >
                    <select
                      ...
                      value={values?.difficulty}
                      onChange={(e) => handleOnChange(e)}
                      className={`w-full px-2 py-2 text-white rounded bg-[#0f212e] focus:outline-none focus:border-transparent ${showRandomField && "cursor-not-allowed opacity-80"
                        }`}
                      disabled={showRandomField}
                    >
                      <option value="easy">Easy</option>
