      ...
      {isManual ? (
       ...
       <div className="flex overflow-x-auto overflow-y-hidden transform translate-z-0">
        <div className="bg-[#0f212e] flex grow rounded-full p-[5px] flex-shrink-0 mt-4">
          <div className="flex space-x-2">
            <button
              className={`py-2 xl:w-[8.7rem] lg:w-[7.09rem] md:w-[12rem] w-[11.3rem] rounded-full ${isManual ? "bg-[#4d718768]" : "hover:bg-[#4d718768]"
                }`}
              onClick={() => setIsManual(true)}
            >
              Manual
            ...
            <button
              className={`py-2 xl:w-[8.7rem] lg:w-[8.1rem] md:w-[13.3rem] w-[11.4rem] rounded-full ${!isManual ? "bg-[#4d718768]" : "hover:bg-[#4d718768]"
                }`}
              onClick={() => setIsManual(false)}
            >
              Auto
