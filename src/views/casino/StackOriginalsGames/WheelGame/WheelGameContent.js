...
function WheelGameContent() {
  ...
  const lowRiskButtons = (
    <>
      <button className="border-b-[#406c82] border-b-8 bg-[#213743] px-20 py-3 rounded-xl">0.00x</button>
      <button className="border-b-[#fcfcfc] border-b-8 bg-[#213743] px-20 py-3 rounded-xl">1.50x</button>
      <button className="border-b-[#1fff20] border-b-8 bg-[#213743] px-20 py-3 rounded-xl">1.80x</button>
    </>
  );

  const mediumRiskButtons = (
    <>
      <button className={`border-b-[#406c82] bg-[#213743] border-b-8 ${wheelValue?.segments === "30" || wheelValue?.segments === 30 ? 'px-8' : 'px-10'} py-3 rounded-xl`}>0.00x</button>
      <button className={`border-b-[#fcfcfc] bg-[#213743] border-b-8 ${wheelValue?.segments === "30" || wheelValue?.segments === 30 ? 'px-8' : 'px-10'} py-3 rounded-xl`}>1.50x</button>
      <button className={`border-b-[#e8e225] bg-[#213743] border-b-8 ${wheelValue?.segments === "30" || wheelValue?.segments === 30 ? 'px-8' : 'px-10'} py-3 rounded-xl`}>1.80x</button>
      <button className={`border-b-[#9322e3] bg-[#213743] border-b-8 ${wheelValue?.segments === "30" || wheelValue?.segments === 30 ? 'px-8' : 'px-10'} py-3 rounded-xl`}>2.00x</button>
      <button className={`border-b-[#8e44ad] bg-[#213743] border-b-8 ${wheelValue?.segments === "30" || wheelValue?.segments === 30 ? 'px-8' : 'px-10'} py-3 rounded-xl`}>3.00x</button>
      {wheelValue?.segments === "30" || wheelValue?.segments === 30 ? <button className="border-b-[#8e44ad] bg-[#213743] border-b-8 px-8 py-3 rounded-xl">3.00x</button> : ""}
    </>
  );

  const highRiskButtons = (
    <>
      <button className="border-b-[#f1c40f] bg-[#213743] border-b-8 px-32 py-3 rounded-xl">2.00x</button>
      <button className="border-b-[#8e44ad] bg-[#213743] border-b-8 px-32 py-3 rounded-xl">3.00x</button>
    </>
  );
