      ...
      <div className="py-3 xl:max-w-[52rem] md:w-full text-[#b1bad3]">
        ...
        <div>
          ...
          <p className="text-[15px] pb-3">
            ...
            you would like to play per game.
          </p>
          ...
          <p className="text-[15px] py-3">
            ...
            win or move up to the next level, unlocking multipliers as you go..
          </p>
          <p className="text-[15px] py-3">
          ...
          <p className="text-[15px] py-3">
            To learn more about how to play, read on or check out our extensive
            Dragon Tower game guide !
          </p>
        </div>
        <div>
          <h1 className="text-white text-xl font-bold pb-3">
        ...
        <div>
          ...
          <ul className="list-disc pl-8">
            ...
            <li className="text-[15px] pb-2">
              ...
              deciding on the amount you play with.
            </li>
            <li className="text-[15px] pb-2">
              The option to opt-out is the most important feature in Dragon
              Tower – deciding when to stop playing and when to go for the next
              multiplier is hugely important and can make or break your
              strategy.
            </li>
            <li className="text-[15px] pb-2">
