...
function Setting() {
  ...
  return (
    <div className="relative">
      <div className=" w-3 h-3 bg-white rotate-45 absolute bottom-[-11px] left-[1.6rem] transform -translate-x-1/2"></div>
      <div className="absolute mt-1 z-10 xl:-left-7 lg:-left-7 md:-left-10 -left-[1.72rem] py-1 bg-white rounded shadow-lg ring-1 ring-black ring-opacity-5 w-32 md:w-32 lg:w-32 ">
