                    ...
                    <div>
                        <DialogContent sx={{ backgroundColor: "#1a2c38", color: "white" }}>
                            ...
                            <div className="flex flex-col justify-center h-full bg-[#1a2c38]">
                                ...
                                <div className={`w-full ${isBetslipOpen || isChatOpen && openMenubar ? "max-w-screen-lg" : "xl:max-w-screen-xl lg:max-w-screen-md md:max-w-screen-sm max-w-sm md:px-0 px-4"} mx-auto`}>
                    ...
                    <div>
                        <DialogContent sx={{ backgroundColor: "#1a2c38", color: "white" }}>
                            <div className="flex flex-col justify-center h-full bg-[#1a2c38]">
                                ...
                                <div className={`w-full ${isBetslipOpen || isChatOpen && openMenubar ? "max-w-screen-lg" : "xl:max-w-screen-xl max-w-sm lg:max-w-screen-md md:max-w-screen-sm md:px-0 px-4"} mx-auto`}>
                                    {IsGameMenu === "AllBets" ? (
                                        <AllBets />
