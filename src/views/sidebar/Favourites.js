    ...
    <div className="min-h-screen bg-[#1a2c38]">
      ...
      <div className="px-4 md:px-8 pt-8 max-w-7xl mx-auto relative">
        ...
        {dropdown && searchResult.length > 0 && (
          <div ref={dropdownRef} className="absolute left-0 right-0 mt-2 bg-[#0f212e] border border-[#213743] rounded-md p-4 z-50">
      ...
      <div className="flex justify-center px-4 py-6">
        <span className="text-[#B1BAD3] text-center flex items-center flex-wrap justify-center">
