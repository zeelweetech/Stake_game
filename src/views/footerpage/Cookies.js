    ...
    <>
      <div className="bg-[#0F212E] rounded-lg p-8 ">
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-slate-700">
                <th className="p-4 text-slate-200">Cookies</th>
                <th className="p-4 text-slate-200">Owner</th>
                <th className="p-4 text-slate-200">Duration</th>
                <th className="p-4 text-slate-200">Description</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                ...
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">2 years</td>
                <td className="p-4 text-slate-300">
                  This cookie stores the preferences and other information of
                  the user. These include, in particular, the preferred
                  language, the number of search results to be displayed on the
                  page, and the decision whether or not to activate Google's
                  SafeSearch filter.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">SIDCC</td>
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">1 day</td>
                <td className="p-4 text-slate-300">
                  Security cookie that protects user data from unauthorized
                  access
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">
                  __Secure-3PSID __Secure-3PAPISID __Secure-1PAPISID
                  __Secure-1PSID
                </td>
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">2 years</td>
                <td className="p-4 text-slate-300">
                  Builds a profile of website visitor interests to show relevant
                  and personalized ads through retargeting.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">
              ...
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">NID</td>
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">6 months</td>
                <td className="p-4 text-slate-300">
                  Stores visitors' preferences and personalizes ads on Google
                  websites based on recent searches and interactions.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">_ga</td>
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">-</td>
                <td className="p-4 text-slate-300">
                  This cookie is a Google Analytics persistent cookie which is
                  used to distinguish unique users.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">1P_JAR</td>
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">1 week</td>
                <td className="p-4 text-slate-300">
                  Based on recent searches and previous interactions, custom ads
                  are shown on Google sites.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">MUID</td>
                <td className="p-4 text-slate-300">Bing.com</td>
                <td className="p-4 text-slate-300">1 month</td>
                <td className="p-4 text-slate-300">
                  Microsoft User Identifier tracking cookie used by Bing Ads.
                </td>
              </tr>
              <tr className="hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">_EDGE_S</td>
                <td className="p-4 text-slate-300">Bing.com</td>
                <td className="p-4 text-slate-300">-</td>
                <td className="p-4 text-slate-300">
              ...
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">OTZ</td>
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">1 month</td>
                <td className="p-4 text-slate-300">
                  Links activities of website visitors to other devices that are
                  previously logged in via the Google account. In this way,
                  advertisements are tailored to different devices.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">_gid</td>
                <td className="p-4 text-slate-300">Google</td>
                <td className="p-4 text-slate-300">1 day</td>
                <td className="p-4 text-slate-300">
                  ...
                  source where they have come from, and the pages visited in an
                  anonymous form.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">_uetvid</td>
                <td className="p-4 text-slate-300">Bing.com</td>
                <td className="p-4 text-slate-300">1 year</td>
                <td className="p-4 text-slate-300">
              ...
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">_uetsid</td>
                <td className="p-4 text-slate-300">Bing.com</td>
                <td className="p-4 text-slate-300">1 day</td>
                <td className="p-4 text-slate-300">
                  Collects data on visitor behaviour from multiple websites, in
                  order to present more relevant advertisement - This also
                  allows the website to limit the number of times that they are
                  shown the same advertisement.
                </td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">fp_token_* io_token_*</td>
                <td className="p-4 text-slate-300">Iovation</td>
                <td className="p-4 text-slate-300">-</td>
                <td className="p-4 text-slate-300">
              ...
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                ...
                <td className="p-4 text-slate-300">Optimove</td>
                <td className="p-4 text-slate-300">-</td>
                <td className="p-4 text-slate-300">Marketing purposes.</td>
              </tr>
              <tr className="border-b border-slate-700 hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">
                  intercom-id-* intercom-session-*
                </td>
                <td className="p-4 text-slate-300">Intercom</td>
                <td className="p-4 text-slate-300">-</td>
                <td className="p-4 text-slate-300">Customer support.</td>
              </tr>
              <tr className="hover:bg-slate-700/50">
                <td className="p-4 text-slate-300">mp_* mixpanel</td>
                <td className="p-4 text-slate-300">Mixpanel</td>
                <td className="p-4 text-slate-300">-</td>
                <td className="p-4 text-slate-300">Marketing purposes.</td>
              </tr>
            </tbody>
        ...
        <div className="mt-8">
          ...
          <a
            href="http://tools.google.com/dlpage/gaoptout?hl=None"
        ...
        <div className="mt-8">
          ...
          <p className="text-slate-300 mb-4">
            ...
            the most popular Internet browsers are provided below for your
          ...
          <ul className="list-disc list-inside text-slate-300 space-y-2 ml-4">
            ...
            <li>
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                http://docs.info.apple.com/article.html?partnum=32467 ↗
              </a>
            </li>
            <li>
              Sportsradar - by visiting the relevant Sportsradar Advertising
              Preferences.
            </li>
          </ul>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-slate-300 mb-4">
            ...
            detailed in the Data Protection Regulation. Every effort has been
          ...
          <p className="text-slate-300">
            ...
            receiving email marketing material. Depending on the products you
            choose to use, we may need to share your Personal Information with
            the third parties that provide those services (e.g. Sportsradar).
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <ul className="list-disc list-inside text-slate-300 space-y-2 ml-4 mb-4">
            <li>
              It is necessary for us to set up or fulfill a contract you have
              entered into with us.
            </li>
            <li>To comply with a legal or regulatory obligation.</li>
            <li>
              Where the recipient is bound by standard contractual clauses or
              binding corporate rules or any other acceptable method that
              ensures the protection of your personal information.
            </li>
          </ul>

          <p className="text-slate-300 mb-4">
            In some instances, we may be compelled by law to disclose your
            Personal Data to a third party and may have limited control over how
            it is protected by that party.
          </p>

          <p className="text-slate-300 mb-4">
            By creating an account with listor.com you accept and understand
            that you are providing your consent to listor.com transferring
        ...
        <div className="mt-8">
          ...
          <p className="text-slate-300 mb-4">
            ...
            accounts may share web links to relevant web pages.
          </p>
