...
const Providers = () => {
    return (
      <div className="max-w-4xl mx-auto px-4 py-8 text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-white">2. Blacklisted Territories</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-white">3. Blacklisted Branded Games Territories</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-white">4. Universal Monsters (Dracula, Creature from the Black Lagoon, Phantoms Curse and The Invisible Man) may only be played in the following territories:</h2>
          <p className="mb-4">
