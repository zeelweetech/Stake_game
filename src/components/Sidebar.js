...
function Sidebar({ handleDrawerToggle, handleMenuOpen }) {
  ...
  return (
    <div
    ref={sidebarRef}
    className={`${openMenubar ? "block" : "hidden md:block"} md:bg-none overflow-x-hidden`}
    >
      <div className="h-14 px-1 py-2 shadow-2xl shadow-black">
        <div className="flex items-center">
          ...
          <button
            ...
            className="text-white ml-3 -mt-4 relative w-[6rem] h-10 group"
            aria-label="Casino"
          >
            <img
              src={casino1}
            ...
            />
            <span
              className={`absolute mt-8 inset-0 flex justify-center items-center font-bold ${
          ...
          <button
            ...
            className="text-white ml-2 -mt-4 relative w-[6rem] h-10 group"
            aria-label="Sports"
          >
            <img
              src={sports}
