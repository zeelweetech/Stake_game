...
import BottomDrawer from "./BottomDrower/BottomSidebar"; // Ensure this is the correct import path
...
function MobileMenubar() {
  ...
  return (
    <div className="px-2 py-2 bg-[#0f212e] text-white md:hidden h-14">
      <div className="flex justify-around w-full items-center">
        ...
        <div className="text-sm" onClick={() => navigate("/casino/home")}>
        ...
        <div className="text-sm" onClick={handleBetDrawerOpen}>
          <svg className="w-4 h-4 hover:fill-white" fill="grey" viewBox="0 0 64 64">
        ...
        <div className=" text-sm" onClick={() => navigate("/comeSoon")}>
          <svg className="w-4 h-4 hover:fill-white" fill="grey" viewBox="0 0 96 96">
        ...
        <div className=" text-sm" onClick={handleChatDrawerOpen}>
          <svg className="w-4 h-4 hover:fill-white" fill="grey" viewBox="0 0 64 64">
