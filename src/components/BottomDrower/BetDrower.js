...
const BetDrower = ({ openDrower, onClose }) => {
  ...
  const highRoller = <IoTrophy className="w-4 h-4 text-white mr-2" />;
  ...
  return (
    <div
      className={`fixed left-0 right-0 bg-[#0f212e] shadow-lg transition-all duration-300 ease-in-out ${
        openDrower ? "bottom-[3.65rem] z-[1000] top-[3.5rem]" : ""
      } flex flex-col`}
    >
      <div className="flex justify-between px-3 items-center bg-[#0f212e] shadow-lg h-12 relative">
        ...
        >
          {selectedView === "My Bets" ? (
            <MyBets className="w-4 h-4 text-white mr-2" />
          ) : selectedView === "All Bets" ? (
            <MyBets className="w-4 h-4 text-white mr-2" />
          ) : selectedView === "High Rollers" ? (
            highRoller
          ) : selectedView === "Races" ? (
            <Races className="w-4 h-4 text-white mr-2" />
          ) : null}
        ...
        {dropdownOpen && (
          <div className="absolute top-full shadow-lg left-16 bg-white text-black font-medium rounded-sm z-10 w-max text-center">
            <button
              ...
              className={`text-gray-700 block py-2 px-4 text-sm ${
            ...
            <button
              ...
              className={`text-gray-700 block py-2 px-4 text-sm ${
                selectedView === "All Bets" && "font-bold"
              }`}
            >
              All Bets
            </button>
            <button
              ...
              className={`text-gray-700 block py-2 px-4 text-sm ${
                selectedView === "High Rollers" && "font-bold"
              }`}
            >
              High Rollers
            </button>
