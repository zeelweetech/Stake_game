...
function MainHeader({handleRightSidebarToggle, isDrawerOpen}) {
  ...
  const handleChatClick = () => {
    dispatch(openChatModal()); // Open Chat Sidebar
    handleRightSidebarToggle();
  };

  const handleBetslipClick = () => {
    dispatch(openBetslipModal()); // Open BetSlip Sidebar
    handleRightSidebarToggle();
  };
      ...
      <div className="bg-[#1a2c38] drop-shadow-2xl py-[0.30rem]">
        ...
        >
          <button
            ...
            onClick={handleChatClick} // Open Chat Sidebar
          >
          ...
          <button
            className="flex items-center space-x-4 py-2"
            onClick={handleBetslipClick} // Open BetSlip Sidebar
          >
          ...
          <div className="tooltip-arrow w-3 h-3 bg-white rotate-45 absolute top-[-6px] left-1/2 transform -translate-x-1/2 mt-1"></div>
              ...
              {/* {isChatOpen && <RightSidebar type="chat" />}
              {isBetslipOpen && <RightSidebar type="betslip" />} */}
            </div>
