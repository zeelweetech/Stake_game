      ...
      <div className="bg-[#1a2c38] drop-shadow-2xl py-[0.30rem]">
        <div className="flex justify-between md:justify-around items-center px-4 md:px-0 ">
          ...
          <div className="flex items-center md:space-x-0">
            <button className="flex bg-[#24455e] items-center bg-transparent space-x-1 px-2 md:px-5 py-2 md:py-3 rounded-s-md text-white font-semibold">
          ...
          <div className="text-white flex items-center space-x-0.4 md:space-x-6">
            ...
            <div className="relative flex items-center">
              ...
              {/* Sidebar Component */}
              <div
                className={`fixed top-0 right-0 h-full bg-gray-800 text-white duration-300 ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'
                  }`}
                style={{ width: '250px' }}
              >
